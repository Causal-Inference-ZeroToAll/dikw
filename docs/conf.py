...
# -*- coding: utf-8 -*-
#
# info documentation build configuration file.
#
...
exclude_patterns = ["_build", "*processor*", "info.batch"]
...
# [howto/manual]).
latex_documents = [
    ("index", "info.tex", "info Documentation", "Someone at Uber", "manual"),
]
...
man_pages = [("index", "info", "info Documentation", [author], 1)]
